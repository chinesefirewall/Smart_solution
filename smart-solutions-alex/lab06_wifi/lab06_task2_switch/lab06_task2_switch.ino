...
String switch_status = "switch_still";
...
void loop() {
  ...
  cm = duration_us / 58.0;
  if (cm <= 10) {
    switch_status = "switch_change";
  } else {
    switch_status = "switch_still";
  }
  
  Serial.print("Byte sent to the AP: ");
  Serial.println(switch_status.substring(6));
  client.println(switch_status);
