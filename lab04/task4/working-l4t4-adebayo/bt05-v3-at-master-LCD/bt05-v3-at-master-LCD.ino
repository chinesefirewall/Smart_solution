...
String BTSlave = "98D3:31:FB3970,1F00,7FFF"; // NIYI
...
String BTSlaveC = "98D3,31,FB3970"; // niyi
...
void loop() {
  ...
  delay(3000); // set delay long enough to enable the slave to process the request and answer
  lcd.clear();
}
