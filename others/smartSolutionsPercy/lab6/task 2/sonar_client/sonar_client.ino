...
void setup() {
  ...
  Serial.println("START");
  Serial.println("START");
  Serial.println("Client_Solar");    //prints filename
...
//Send data to the IP address & port of the AP
    ...
    char message[3];                          
    sprintf(message, "%d", distance_to_obj);
    port.write(message);
    port.write("\r\n");
    port.endPacket();
    Serial.print("Sending following message to AP ->");
