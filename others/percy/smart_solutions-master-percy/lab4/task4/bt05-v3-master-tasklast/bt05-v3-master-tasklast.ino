...
// xxxx:yy:zzzzzz
// This address taken from terminal when it initializes
// xxxx,yy,zzzzzz+INQ:13:EF:83B5,1F00,7FFF
String BTSlave="13:EF:2465,1F00,7FFF";
String BTSlaveC="0013,EF,002465";
...
if(bt.available())
{ 
  //reads message as string
  messagein=bt.readStringUntil("\n");
  // Displays on LED
  lcd.clear();
  lcd.setCursor(0,0); 
  lcd.print(messagein);
